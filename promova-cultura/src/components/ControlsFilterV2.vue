...
export default {
    ...
    methods: {
        changeValueProponente: function () { 
            ...
            if (this.proponenteTextButton === 'Omitindo proponentes'){
                this.proponenteTextButton = 'Mostrando proponentes'
                elementProp.classList.add('btn-info')
            } else {
                this.proponenteTextButton = 'Omitindo proponentes'
        ...
        changeValueIncentivadores: function () {
            ...
            if (this.incentivadoresTextButton === 'Omitindo incentivadores'){
                this.incentivadoresTextButton = 'Mostrando incentivadores'
                elementInc.classList.add('btn-warning')
            } else {
                this.incentivadoresTextButton = 'Omitindo incentivadores'
